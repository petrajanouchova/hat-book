...
{\bTABLE
\bTR \bTD \getbuffer text 1 \eTD
\bTD \getbuffer text 2 \eTD \bTD first \eTD \eTR
\bTR \bTD \getbuffer text 3 \eTD
\bTD \getbuffer text 4 \eTD \bTD second \eTD \eTR
\eTABLE}
...
\bTR \bTD[nc=2] \getbuffer this is one of \index{the} the tables \eTD \eTR
\bTR \bTD \getbuffer text 1 \eTD \bTD \getbuffer text 2 \eTD \eTR
\bTR \bTD \getbuffer text 3 \eTD \bTD \getbuffer text 4 \eTD \eTR
\eTABLE}


\subject{Bibliography}

Aladzhov, A., Dimitrov, Y., Stamenov, S., Stamenova, V., Stoyanova, H., Ivanov, S. \index{and} and Stoychev, S. 2013. {\em Arheologicheska karta na Pliska}. Sofia: Bulvest Print.

Aladzhov, D. 1974. {\em Selishta, pametnitsi, nahodki, Materiali za arheologicheska karta na Haskovski okrag}. Haskovo: Nauchno-populyarna muzeina biblio\index{the} theka.
